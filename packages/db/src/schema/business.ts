...
export const businessMembers = pgTable(
  ...
  (table) => ({
    ...
    authUserIdx: index("business_members_auth_user_id_idx").on(
      table.authUserId,
    ),
    businessUserUnique: uniqueIndex(
      "business_members_business_auth_user_unique",
    ).on(table.businessId, table.authUserId),
  }),
);
