...
export const shifts = pgTable(
  "shifts",
  {
    ...
    startedBy: uuid("started_by").references(() => employees.id, {
      onDelete: "set null",
    }),
  ...
  (table) => ({
    ...
    businessClientIdUnique: uniqueIndex(
      "shifts_business_client_generated_id_unique",
...
export const shiftAssignments = pgTable(
  "shift_assignments",
  {
    ...
    roleOnShift: shiftAssignmentRoleEnum("role_on_shift")
      .default("employee")
      .notNull(),
    salaryRateCents: bigint("salary_rate_cents", { mode: "number" })
      .default(0)
      .notNull(),
...
export const shiftCosts = pgTable(
  "shift_costs",
  {
    id: uuid("id").primaryKey(),
    businessId: uuid("business_id")
