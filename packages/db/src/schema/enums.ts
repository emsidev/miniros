...
export const saleChangeRequestTypeEnum = pgEnum("sale_change_request_type", [
  "void",
  "refund",
  "correction",
]);
...
export const closeoutStatusEnum = pgEnum("closeout_status", [
  "draft",
  "submitted",
  "approved",
  "rejected",
]);
export const profitResultEnum = pgEnum("profit_result", [
  "profit",
  "break_even",
  "loss",
]);
...
export const offlineActionStatusEnum = pgEnum("offline_action_status", [
  "pending",
  "processing",
  "synced",
  "failed",
